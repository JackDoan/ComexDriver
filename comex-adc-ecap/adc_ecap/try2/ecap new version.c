...
__interrupt void ecap1_isr(void)
{
   ...
   HallsensorA = GpioDataRegs.GPADAT.bit.GPIO5;  // read th signal
...
__interrupt void ecap2_isr(void)
{
	...
	EALLOW;
	   GpioCtrlRegs.GPAMUX2.bit.GPIO25 = 0;        //  GPIO5 as I/O
	   GpioCtrlRegs.GPADIR.bit.GPIO25 = 0;          // GPIO5 as input
	   EDIS;

	   HallsensorB = GpioDataRegs.GPADAT.bit.GPIO25;  // read th signal
	   ...
	   EALLOW;
	   GpioCtrlRegs.GPAMUX1.bit.GPIO5 = 1; // Back to capture mode   GPIO25 as ecap
	   EDIS;
