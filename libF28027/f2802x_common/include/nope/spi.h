...
typedef enum
{
    SPI_Priority_Immediate=(0 << 3),        //!< Stops immediately after EMU halt
    SPI_Priority_FreeRun=(1 << 3),        //!< Doesn't stop after EMU halt
    SPI_Priority_AfterRxRxSeq=(2 << 3)    //!< Stops after EMU halt and next rx/rx sequence
} SPI_Priority_e;
