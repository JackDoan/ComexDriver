...
#include "include/F2806x_Adc.h"                // ADC Registers
#include "include/F2806x_BootVars.h"		   // Boot ROM Variables
#include "include/F2806x_Cla.h"                // Control Law Accelerator Registers
#include "include/F2806x_Comp.h"               // Comparator Registers
#include "include/F2806x_CpuTimers.h"          // 32-bit CPU Timers
#include "include/F2806x_DevEmu.h"             // Device Emulation Registers
#include "include/F2806x_Dma.h"				   // Direct Memory Access Registers
#include "include/F2806x_ECan.h"               // Enhanced CAN Registers
#include "include/F2806x_ECap.h"               // Enhanced Capture
#include "include/F2806x_EPwm.h"               // Enhanced PWM
#include "include/F2806x_EQep.h"               // Enhanced QEP
#include "include/F2806x_Gpio.h"               // General Purpose I/O Registers
#include "include/F2806x_HRCap.h"			   // High Resolution Capture Registers
#include "include/F2806x_I2c.h"                // I2C Registers
#include "include/F2806x_Mcbsp.h"			   // McBSP Registers
#include "include/F2806x_NmiIntrupt.h"         // NMI Interrupt Registers
#include "include/F2806x_PieCtrl.h"            // PIE Control Registers
#include "include/F2806x_PieVect.h"            // PIE Vector Table
#include "include/F2806x_Spi.h"                // SPI Registers
#include "include/F2806x_Sci.h"                // SCI Registers
#include "include/F2806x_SysCtrl.h"            // System Control/Power Modes
#include "include/F2806x_Usb.h"				   // USB Registers
#include "include/F2806x_XIntrupt.h"           // External Interrupts
...
#endif  // end of include/F2806x_DEVICE_H definition
