...
=======
	EPwm1Regs.CHPEN = enableChops;
	EPwm1Regs.CHPFREQ = 0b111; //divide by 8 = ~1 MHz
	EPwm1Regs.CHPDUTY = chop;
...
=======
	EPwm2Regs.CHPEN = enableChops;
	EPwm2Regs.CHPFREQ = 0b111; //divide by 8 = ~1 MHz
	EPwm2Regs.CHPDUTY = chop;

	EPwm3Regs.TBPRD = freq; // Period = 2(freq)/(TBCLK) = freq/40,000
	EPwm3Regs.TBPHS.half.TBPHS = freq/3; // Set Phase register
	EPwm3Regs.TBCTL.bit.CTRMODE = TB_COUNT_UPDOWN; // Symmetrical mode
	EPwm3Regs.TBCTL.bit.PHSEN = TB_ENABLE; // slave module
	EPwm3Regs.TBCTL.bit.PHSDIR = TB_DOWN; // Count DOWN on sync (=240 deg)
    EPwm3Regs.TBCTL.bit.PRDLD = TB_SHADOW;
...
<<<<<<< HEAD
=======
	EPwm3Regs.CHPEN = enableChops;
	EPwm3Regs.CHPFREQ = 0b111; //divide by 8 = ~1 MHz
	EPwm3Regs.CHPDUTY = chop;
>>>>>>> 85d9b38348f9d4052276f6f7136d82cb13c301ae
